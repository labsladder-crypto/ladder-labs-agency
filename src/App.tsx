...
${data.message}
  ...
  return (
    <div className="min-h-screen selection:bg-brand-cyan/30 overflow-x-hidden">
      ...
      <div className="fixed top-24 right-5 z-40 lg:hidden flex flex-col gap-2">
        <a
          href="#radar"
          onClick={(e) => {
            e.preventDefault();
          ...
          className="w-8 h-8 bg-brand-cyan rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,255,255,0.3)] hover:scale-110 transition-transform"
        ...
        <a
          ...
          className="w-8 h-8 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-8 h-8 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform"
